export const teamNotificationSMS = (name: string, phoneNumber: string = "(488)-435-9067", emailAddress: string = "doctorsimpsonswag@gmail.com",
...
export default teamNotificationSMS;